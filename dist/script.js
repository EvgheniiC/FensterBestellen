...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(form); //собирает все данные - input
...
var modals = function modals() {
  ...
  function showModalInTimeout(selector, time) {
    // через сколько времени будет вызвано окно
    setTimeout(function () {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); //showModalInTimeout('.popup',60000);
};
...
var tabs = function tabs(headerSelector, tabsSelector, contetsSelector, activeClass) {
